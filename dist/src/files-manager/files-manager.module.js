...
const files_manager_controller_1 = require("./files-manager.controller");
...
exports.FilesManagerModule = FilesManagerModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [files_manager_service_1.FilesManagerService],
        controllers: [files_manager_controller_1.FilesManagerController]
    })
], FilesManagerModule);
//# sourceMappingURL=files-manager.module.js.map